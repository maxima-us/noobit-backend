"""overload uvicorn config file so we can use our own logger"""
...
from noobit.server.app_startup import lifespan
...
class Config:
    ...
    def load(self):
        ...
        # load our own lifespan
        self.lifespan_class = lifespan.LifespanOn
        # self.lifespan_class.logger = get_logger(__name__)
